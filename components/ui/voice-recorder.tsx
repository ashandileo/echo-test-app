    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="text-center text-sm text-gray-600 dark:text-gray-400 space-y-1">
        {!audioUrl && !isRecording && (
          <>
            <p>Click the button above to start recording your answer</p>
            <p className="text-xs">
              Make sure your microphone is connected and allowed
            </p>
            <p className="text-xs font-medium text-orange-600 dark:text-orange-400">
              ⚠️ You can only upload 1 audio per question
            </p>
          </>
        )}
        {isRecording && (
        ...
        {audioUrl && !isRecording && (
          <>
            ...
            <p className="text-xs font-medium text-orange-600 dark:text-orange-400">
              💡 To record again, delete this recording first
            </p>
          </>
        )}
      </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              be undone and you will need to record again.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
